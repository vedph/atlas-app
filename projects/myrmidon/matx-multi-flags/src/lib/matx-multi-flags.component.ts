...
/**
 * A generic flag, having an ID and a human-friendly label.
 */
export interface MatxFlag {
  id: string;
  label: string;
}
 ...
 * Usage: <matx-multi-flags
 *        [selectedIds]="arrayOfSelectedIds"
 *        [flags]="arrayOfAvailableFlags"
 *        [numbering]="false"
 *        [toolbar]="false"
 *        (selectionChange)="handlerGettingIdsArray"
 *        ></matx-multi-flags>
 */
@Component({
  selector: 'matx-multi-flags',
  templateUrl: './matx-multi-flags.component.html',
  styleUrls: ['./matx-multi-flags.component.css'],
})
export class MatxMultiFlagsComponent implements OnInit, OnDestroy {
  private _ids: string[];
  private _flags: MatxFlag[];
   ...
   */
  @Input()
  public get flags(): MatxFlag[] | undefined {
    return this._flags;
  }
  public set flags(value: MatxFlag[] | undefined) {
    this._flags = value || [];
    this._data$.next({
      selectedIds: this._ids,
      flags: this._flags,
